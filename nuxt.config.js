...
export default {
  ...
  loading: { color: '#6c6aff', height: '4px', duration: 5000, throttle: 0 },
  /*
   ** Global CSS
   */
  css: [],
  ...
  buildModules: [
    ...
    '@nuxtjs/vuetify',
    // to set and use global environment variables:
    '@nuxtjs/dotenv',
  ],
  /*
   ** Nuxt.js modules
  ...
  firebase: {
    ...
    services: {
      ...
      auth: {
        ssr: false,
        initialize: {
          // This sets up an onAuthStateChanged() listener
          // and hooks it up to the vuex store.
